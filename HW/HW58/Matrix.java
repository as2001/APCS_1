...
public class Matrix 
{
	...
	Object[] row = {0,1,2};
	m3.setRow(1,row);
	System.out.println("m3 after setRow: \n" + m3);
	Object[] col = {9,8,7};
	m3.setCol(2,col);
	System.out.println("m3 after setCol: \n" + m3);
	m3.transpose();
	System.out.println("m3 after transpose: \n" + m3);
    }//end main()
